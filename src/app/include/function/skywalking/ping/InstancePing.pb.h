...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_register_2fInstancePing_2eproto_metadata_getter(int index);
...
class ServiceInstancePingPkg PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ServiceInstancePingPkg) */ {
 public:
  inline ServiceInstancePingPkg() : ServiceInstancePingPkg(nullptr) {}
  virtual ~ServiceInstancePingPkg();
  explicit constexpr ServiceInstancePingPkg(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(ServiceInstancePingPkg* other) {
    if (other == this) return;
  ...
  protected:
  explicit ServiceInstancePingPkg(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_register_2fInstancePing_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
inline void ServiceInstancePingPkg::set_serviceinstanceuuid(const char* value) {
  ...
  serviceinstanceuuid_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:ServiceInstancePingPkg.serviceInstanceUUID)
}
inline void ServiceInstancePingPkg::set_serviceinstanceuuid(const char* value,
    size_t size) {
  
  serviceinstanceuuid_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
...
inline std::string* ServiceInstancePingPkg::_internal_mutable_serviceinstanceuuid() {
  ...
  return serviceinstanceuuid_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* ServiceInstancePingPkg::release_serviceinstanceuuid() {
  ...
  return serviceinstanceuuid_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void ServiceInstancePingPkg::set_allocated_serviceinstanceuuid(std::string* serviceinstanceuuid) {
  ...
  serviceinstanceuuid_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), serviceinstanceuuid,
      GetArena());
