...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_register_2fRegister_2eproto_metadata_getter(int index);
class AgentInstance;
struct AgentInstanceDefaultTypeInternal;
extern AgentInstanceDefaultTypeInternal _AgentInstance_default_instance_;
class Endpoint;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::AgentInstance* Arena::CreateMaybeMessage<::AgentInstance>(Arena*);
...
template<> ::Plugin* Arena::CreateMaybeMessage<::Plugin>(Arena*);
...
class Services PROTOBUF_FINAL :
 ...
 public:
  ...
  virtual ~Services();
  explicit constexpr Services(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_register_2fRegister_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
class ServiceRegisterMapping PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ServiceRegisterMapping) */ {
 public:
  inline ServiceRegisterMapping() : ServiceRegisterMapping(nullptr) {}
  virtual ~ServiceRegisterMapping();
  explicit constexpr ServiceRegisterMapping(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(ServiceRegisterMapping* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  protected:
  explicit ServiceRegisterMapping(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
...
class ServiceInstances PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ServiceInstances) */ {
 public:
  inline ServiceInstances() : ServiceInstances(nullptr) {}
  virtual ~ServiceInstances();
  explicit constexpr ServiceInstances(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(ServiceInstances* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  protected:
  explicit ServiceInstances(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
...
class ServiceInstance PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ServiceInstance) */ {
 public:
  inline ServiceInstance() : ServiceInstance(nullptr) {}
  virtual ~ServiceInstance();
  explicit constexpr ServiceInstance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(ServiceInstance* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  protected:
  explicit ServiceInstance(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  enum : int {
    ...
    kPluginsFieldNumber = 6,
    kInstanceUUIDFieldNumber = 2,
    kAgentInstanceFieldNumber = 7,
    kTimeFieldNumber = 3,
  ...
  public:
  void clear_plugins();
  ::Plugin* mutable_plugins(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Plugin >*
      mutable_plugins();
  private:
  const ::Plugin& _internal_plugins(int index) const;
  ::Plugin* _internal_add_plugins();
  public:
  const ::Plugin& plugins(int index) const;
  ::Plugin* add_plugins();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Plugin >&
      plugins() const;
  ...
  bool has_agentinstance() const;
  private:
  bool _internal_has_agentinstance() const;
  public:
  void clear_agentinstance();
  const ::AgentInstance& agentinstance() const;
  ::AgentInstance* release_agentinstance();
  ::AgentInstance* mutable_agentinstance();
  void set_allocated_agentinstance(::AgentInstance* agentinstance);
  private:
  const ::AgentInstance& _internal_agentinstance() const;
  ::AgentInstance* _internal_mutable_agentinstance();
  public:
  void unsafe_arena_set_allocated_agentinstance(
      ::AgentInstance* agentinstance);
  ::AgentInstance* unsafe_arena_release_agentinstance();
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::KeyStringValuePair > tags_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::KeyStringValuePair > properties_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Plugin > plugins_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr instanceuuid_;
  ::AgentInstance* agentinstance_;
...
class Plugin PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Plugin) */ {
 public:
  ...
  enum : int {
    ...
    kPluginVersionFieldNumber = 2,
    kActivationFieldNumber = 3,
  };
  // string pluginName = 1;
  void clear_pluginname();
  const std::string& pluginname() const;
  void set_pluginname(const std::string& value);
  void set_pluginname(std::string&& value);
  void set_pluginname(const char* value);
  void set_pluginname(const char* value, size_t size);
  std::string* mutable_pluginname();
  std::string* release_pluginname();
  void set_allocated_pluginname(std::string* pluginname);
  private:
  const std::string& _internal_pluginname() const;
  void _internal_set_pluginname(const std::string& value);
  std::string* _internal_mutable_pluginname();
  public:

  // string pluginVersion = 2;
  void clear_pluginversion();
  const std::string& pluginversion() const;
  void set_pluginversion(const std::string& value);
  void set_pluginversion(std::string&& value);
  void set_pluginversion(const char* value);
  void set_pluginversion(const char* value, size_t size);
  std::string* mutable_pluginversion();
  std::string* release_pluginversion();
  void set_allocated_pluginversion(std::string* pluginversion);
  private:
  const std::string& _internal_pluginversion() const;
  void _internal_set_pluginversion(const std::string& value);
  std::string* _internal_mutable_pluginversion();
  public:
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr pluginname_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr pluginversion_;
...
class AgentInstance PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:AgentInstance) */ {
 public:
  inline AgentInstance() : AgentInstance(nullptr) {}
  virtual ~AgentInstance();
  explicit constexpr AgentInstance(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  AgentInstance(const AgentInstance& from);
  AgentInstance(AgentInstance&& from) noexcept
    : AgentInstance() {
    *this = ::std::move(from);
  }

  inline AgentInstance& operator=(const AgentInstance& from) {
    CopyFrom(from);
    return *this;
  }
  inline AgentInstance& operator=(AgentInstance&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const AgentInstance& default_instance() {
    return *internal_default_instance();
  }
  static inline const AgentInstance* internal_default_instance() {
    return reinterpret_cast<const AgentInstance*>(
               &_AgentInstance_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    6;

  friend void swap(AgentInstance& a, AgentInstance& b) {
    a.Swap(&b);
  }
  inline void Swap(AgentInstance* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(AgentInstance* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline AgentInstance* New() const final {
    return CreateMaybeMessage<AgentInstance>(nullptr);
  }

  AgentInstance* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<AgentInstance>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const AgentInstance& from);
  void MergeFrom(const AgentInstance& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(AgentInstance* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "AgentInstance";
  }
  protected:
  explicit AgentInstance(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:AgentInstance)
 private:
  class _Internal;
...
class ServiceInstanceRegisterMapping PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ServiceInstanceRegisterMapping) */ {
 public:
  inline ServiceInstanceRegisterMapping() : ServiceInstanceRegisterMapping(nullptr) {}
  virtual ~ServiceInstanceRegisterMapping();
  explicit constexpr ServiceInstanceRegisterMapping(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(ServiceInstanceRegisterMapping* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  protected:
  explicit ServiceInstanceRegisterMapping(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
...
class NetAddresses PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:NetAddresses) */ {
 public:
  inline NetAddresses() : NetAddresses(nullptr) {}
  virtual ~NetAddresses();
  explicit constexpr NetAddresses(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(NetAddresses* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  protected:
  explicit NetAddresses(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
...
class NetAddressMapping PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:NetAddressMapping) */ {
 public:
  inline NetAddressMapping() : NetAddressMapping(nullptr) {}
  virtual ~NetAddressMapping();
  explicit constexpr NetAddressMapping(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(NetAddressMapping* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  protected:
  explicit NetAddressMapping(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
...
class EndpointMapping PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:EndpointMapping) */ {
 public:
  inline EndpointMapping() : EndpointMapping(nullptr) {}
  virtual ~EndpointMapping();
  explicit constexpr EndpointMapping(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(EndpointMapping* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  protected:
  explicit EndpointMapping(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
...
class EndpointMappingElement PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:EndpointMappingElement) */ {
 public:
  inline EndpointMappingElement() : EndpointMappingElement(nullptr) {}
  virtual ~EndpointMappingElement();
  explicit constexpr EndpointMappingElement(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(EndpointMappingElement* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  protected:
  explicit EndpointMappingElement(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
...
class ServiceAndNetworkAddressMappings PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ServiceAndNetworkAddressMappings) */ {
 public:
  inline ServiceAndNetworkAddressMappings() : ServiceAndNetworkAddressMappings(nullptr) {}
  virtual ~ServiceAndNetworkAddressMappings();
  explicit constexpr ServiceAndNetworkAddressMappings(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(ServiceAndNetworkAddressMappings* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  protected:
  explicit ServiceAndNetworkAddressMappings(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
...
class ServiceAndNetworkAddressMapping PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ServiceAndNetworkAddressMapping) */ {
 public:
  inline ServiceAndNetworkAddressMapping() : ServiceAndNetworkAddressMapping(nullptr) {}
  virtual ~ServiceAndNetworkAddressMapping();
  explicit constexpr ServiceAndNetworkAddressMapping(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  void UnsafeArenaSwap(ServiceAndNetworkAddressMapping* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  protected:
  explicit ServiceAndNetworkAddressMapping(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
...
inline const std::string& ServiceInstance::_internal_instanceuuid() const {
  return instanceuuid_.Get();
}
inline void ServiceInstance::_internal_set_instanceuuid(const std::string& value) {
  
  instanceuuid_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void ServiceInstance::set_instanceuuid(const char* value) {
  ...
  instanceuuid_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:ServiceInstance.instanceUUID)
}
inline void ServiceInstance::set_instanceuuid(const char* value,
    size_t size) {
  
  instanceuuid_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* ServiceInstance::_internal_mutable_instanceuuid() {
  ...
  return instanceuuid_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* ServiceInstance::release_instanceuuid() {
  // @@protoc_insertion_point(field_release:ServiceInstance.instanceUUID)
  return instanceuuid_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void ServiceInstance::set_allocated_instanceuuid(std::string* instanceuuid) {
  ...
  instanceuuid_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), instanceuuid,
      GetArena());
...
// repeated .Plugin plugins = 6;
inline int ServiceInstance::_internal_plugins_size() const {
  return plugins_.size();
}
inline int ServiceInstance::plugins_size() const {
  return _internal_plugins_size();
}
inline void ServiceInstance::clear_plugins() {
  plugins_.Clear();
}
inline ::Plugin* ServiceInstance::mutable_plugins(int index) {
  // @@protoc_insertion_point(field_mutable:ServiceInstance.plugins)
  return plugins_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Plugin >*
ServiceInstance::mutable_plugins() {
  // @@protoc_insertion_point(field_mutable_list:ServiceInstance.plugins)
  return &plugins_;
}
inline const ::Plugin& ServiceInstance::_internal_plugins(int index) const {
  return plugins_.Get(index);
}
inline const ::Plugin& ServiceInstance::plugins(int index) const {
  // @@protoc_insertion_point(field_get:ServiceInstance.plugins)
  return _internal_plugins(index);
}
inline ::Plugin* ServiceInstance::_internal_add_plugins() {
  return plugins_.Add();
}
inline ::Plugin* ServiceInstance::add_plugins() {
  // @@protoc_insertion_point(field_add:ServiceInstance.plugins)
  return _internal_add_plugins();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Plugin >&
ServiceInstance::plugins() const {
  // @@protoc_insertion_point(field_list:ServiceInstance.plugins)
  return plugins_;
}

// .AgentInstance agentInstance = 7;
inline bool ServiceInstance::_internal_has_agentinstance() const {
  return this != internal_default_instance() && agentinstance_ != nullptr;
}
inline bool ServiceInstance::has_agentinstance() const {
  return _internal_has_agentinstance();
}
inline void ServiceInstance::clear_agentinstance() {
  if (GetArena() == nullptr && agentinstance_ != nullptr) {
    delete agentinstance_;
  }
  agentinstance_ = nullptr;
}
inline const ::AgentInstance& ServiceInstance::_internal_agentinstance() const {
  const ::AgentInstance* p = agentinstance_;
  return p != nullptr ? *p : reinterpret_cast<const ::AgentInstance&>(
      ::_AgentInstance_default_instance_);
}
inline const ::AgentInstance& ServiceInstance::agentinstance() const {
  // @@protoc_insertion_point(field_get:ServiceInstance.agentInstance)
  return _internal_agentinstance();
}
inline void ServiceInstance::unsafe_arena_set_allocated_agentinstance(
    ::AgentInstance* agentinstance) {
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(agentinstance_);
  }
  agentinstance_ = agentinstance;
  if (agentinstance) {
    
  } else {
    
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ServiceInstance.agentInstance)
}
inline ::AgentInstance* ServiceInstance::release_agentinstance() {
  
  ::AgentInstance* temp = agentinstance_;
  agentinstance_ = nullptr;
  if (GetArena() != nullptr) {
...
inline ::AgentInstance* ServiceInstance::unsafe_arena_release_agentinstance() {
  // @@protoc_insertion_point(field_release:ServiceInstance.agentInstance)
  
  ::AgentInstance* temp = agentinstance_;
  agentinstance_ = nullptr;
  return temp;
}
inline ::AgentInstance* ServiceInstance::_internal_mutable_agentinstance() {
  
  if (agentinstance_ == nullptr) {
    auto* p = CreateMaybeMessage<::AgentInstance>(GetArena());
    agentinstance_ = p;
  }
  return agentinstance_;
}
inline ::AgentInstance* ServiceInstance::mutable_agentinstance() {
  // @@protoc_insertion_point(field_mutable:ServiceInstance.agentInstance)
  return _internal_mutable_agentinstance();
}
inline void ServiceInstance::set_allocated_agentinstance(::AgentInstance* agentinstance) {
  ...
  if (agentinstance) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(agentinstance);
    if (message_arena != submessage_arena) {
      agentinstance = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, agentinstance, submessage_arena);
    }
  ...
  agentinstance_ = agentinstance;
  // @@protoc_insertion_point(field_set_allocated:ServiceInstance.agentInstance)
}
...
// string pluginName = 1;
inline void Plugin::clear_pluginname() {
  pluginname_.ClearToEmpty();
}
inline const std::string& Plugin::pluginname() const {
  // @@protoc_insertion_point(field_get:Plugin.pluginName)
  return _internal_pluginname();
}
inline void Plugin::set_pluginname(const std::string& value) {
  _internal_set_pluginname(value);
  // @@protoc_insertion_point(field_set:Plugin.pluginName)
}
inline std::string* Plugin::mutable_pluginname() {
  // @@protoc_insertion_point(field_mutable:Plugin.pluginName)
  return _internal_mutable_pluginname();
}
inline const std::string& Plugin::_internal_pluginname() const {
  return pluginname_.Get();
}
inline void Plugin::_internal_set_pluginname(const std::string& value) {
  
  pluginname_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void Plugin::set_pluginname(std::string&& value) {
  
  pluginname_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:Plugin.pluginName)
}
inline void Plugin::set_pluginname(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  pluginname_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:Plugin.pluginName)
}
inline void Plugin::set_pluginname(const char* value,
    size_t size) {
  
  pluginname_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:Plugin.pluginName)
}
inline std::string* Plugin::_internal_mutable_pluginname() {
  
  return pluginname_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* Plugin::release_pluginname() {
  // @@protoc_insertion_point(field_release:Plugin.pluginName)
  return pluginname_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void Plugin::set_allocated_pluginname(std::string* pluginname) {
  if (pluginname != nullptr) {
    
  } else {
    
  }
  pluginname_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), pluginname,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:Plugin.pluginName)
}

// string pluginVersion = 2;
inline void Plugin::clear_pluginversion() {
  pluginversion_.ClearToEmpty();
}
inline const std::string& Plugin::pluginversion() const {
  // @@protoc_insertion_point(field_get:Plugin.pluginVersion)
  return _internal_pluginversion();
}
inline void Plugin::set_pluginversion(const std::string& value) {
  _internal_set_pluginversion(value);
  // @@protoc_insertion_point(field_set:Plugin.pluginVersion)
}
inline std::string* Plugin::mutable_pluginversion() {
  // @@protoc_insertion_point(field_mutable:Plugin.pluginVersion)
  return _internal_mutable_pluginversion();
}
inline const std::string& Plugin::_internal_pluginversion() const {
  return pluginversion_.Get();
}
inline void Plugin::_internal_set_pluginversion(const std::string& value) {
  
  pluginversion_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void Plugin::set_pluginversion(std::string&& value) {
  
  pluginversion_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:Plugin.pluginVersion)
}
inline void Plugin::set_pluginversion(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  pluginversion_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:Plugin.pluginVersion)
}
inline void Plugin::set_pluginversion(const char* value,
    size_t size) {
  
  pluginversion_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:Plugin.pluginVersion)
}
inline std::string* Plugin::_internal_mutable_pluginversion() {
  
  return pluginversion_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* Plugin::release_pluginversion() {
  // @@protoc_insertion_point(field_release:Plugin.pluginVersion)
  return pluginversion_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void Plugin::set_allocated_pluginversion(std::string* pluginversion) {
  if (pluginversion != nullptr) {
    
  } else {
    
  }
  pluginversion_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), pluginversion,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:Plugin.pluginVersion)
}

// string activation = 3;
inline void Plugin::clear_activation() {
  activation_.ClearToEmpty();
}
inline const std::string& Plugin::activation() const {
  // @@protoc_insertion_point(field_get:Plugin.activation)
  return _internal_activation();
}
inline void Plugin::set_activation(const std::string& value) {
  _internal_set_activation(value);
  // @@protoc_insertion_point(field_set:Plugin.activation)
}
inline std::string* Plugin::mutable_activation() {
  // @@protoc_insertion_point(field_mutable:Plugin.activation)
  return _internal_mutable_activation();
}
inline const std::string& Plugin::_internal_activation() const {
  return activation_.Get();
}
inline void Plugin::_internal_set_activation(const std::string& value) {
  
  activation_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void Plugin::set_activation(std::string&& value) {
  
  activation_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:Plugin.activation)
}
inline void Plugin::set_activation(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  activation_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:Plugin.activation)
}
inline void Plugin::set_activation(const char* value,
    size_t size) {
  ...
  activation_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:Plugin.activation)
}
inline std::string* Plugin::_internal_mutable_activation() {
  
  return activation_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* Plugin::release_activation() {
  // @@protoc_insertion_point(field_release:Plugin.activation)
  return activation_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void Plugin::set_allocated_activation(std::string* activation) {
  ...
  activation_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), activation,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:Plugin.activation)
}
...
// string agentVersion = 1;
inline void AgentInstance::clear_agentversion() {
  agentversion_.ClearToEmpty();
}
inline const std::string& AgentInstance::agentversion() const {
  // @@protoc_insertion_point(field_get:AgentInstance.agentVersion)
  return _internal_agentversion();
}
inline void AgentInstance::set_agentversion(const std::string& value) {
  _internal_set_agentversion(value);
  // @@protoc_insertion_point(field_set:AgentInstance.agentVersion)
}
inline std::string* AgentInstance::mutable_agentversion() {
  // @@protoc_insertion_point(field_mutable:AgentInstance.agentVersion)
  return _internal_mutable_agentversion();
}
inline const std::string& AgentInstance::_internal_agentversion() const {
  return agentversion_.Get();
}
inline void AgentInstance::_internal_set_agentversion(const std::string& value) {
  
  agentversion_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void AgentInstance::set_agentversion(std::string&& value) {
  
  agentversion_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:AgentInstance.agentVersion)
}
inline void AgentInstance::set_agentversion(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  agentversion_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:AgentInstance.agentVersion)
}
inline void AgentInstance::set_agentversion(const char* value,
    size_t size) {
  
  agentversion_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:AgentInstance.agentVersion)
}
inline std::string* AgentInstance::_internal_mutable_agentversion() {
  
  return agentversion_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* AgentInstance::release_agentversion() {
  // @@protoc_insertion_point(field_release:AgentInstance.agentVersion)
  return agentversion_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void AgentInstance::set_allocated_agentversion(std::string* agentversion) {
  ...
  agentversion_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), agentversion,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:AgentInstance.agentVersion)
}

// string appName = 2;
inline void AgentInstance::clear_appname() {
  appname_.ClearToEmpty();
}
inline const std::string& AgentInstance::appname() const {
  // @@protoc_insertion_point(field_get:AgentInstance.appName)
  return _internal_appname();
}
inline void AgentInstance::set_appname(const std::string& value) {
  _internal_set_appname(value);
  // @@protoc_insertion_point(field_set:AgentInstance.appName)
}
inline std::string* AgentInstance::mutable_appname() {
  // @@protoc_insertion_point(field_mutable:AgentInstance.appName)
  return _internal_mutable_appname();
}
inline const std::string& AgentInstance::_internal_appname() const {
  return appname_.Get();
}
inline void AgentInstance::_internal_set_appname(const std::string& value) {
  
  appname_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
inline void AgentInstance::set_appname(std::string&& value) {
  
  appname_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:AgentInstance.appName)
}
inline void AgentInstance::set_appname(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  appname_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:AgentInstance.appName)
}
inline void AgentInstance::set_appname(const char* value,
    size_t size) {
  ...
  appname_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:AgentInstance.appName)
}
inline std::string* AgentInstance::_internal_mutable_appname() {
  
  return appname_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* AgentInstance::release_appname() {
  // @@protoc_insertion_point(field_release:AgentInstance.appName)
  return appname_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void AgentInstance::set_allocated_appname(std::string* appname) {
  if (appname != nullptr) {
  ...
  appname_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), appname,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:AgentInstance.appName)
}
...
inline const std::string& Endpoint::_internal_endpointname() const {
  return endpointname_.Get();
}
inline void Endpoint::_internal_set_endpointname(const std::string& value) {
  
  endpointname_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void Endpoint::set_endpointname(const char* value) {
  ...
  endpointname_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:Endpoint.endpointName)
}
inline void Endpoint::set_endpointname(const char* value,
    size_t size) {
  
  endpointname_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:Endpoint.endpointName)
}
inline std::string* Endpoint::_internal_mutable_endpointname() {
  
  return endpointname_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* Endpoint::release_endpointname() {
  // @@protoc_insertion_point(field_release:Endpoint.endpointName)
  return endpointname_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void Endpoint::set_allocated_endpointname(std::string* endpointname) {
  ...
  endpointname_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), endpointname,
      GetArena());
...
inline const std::string& ServiceAndNetworkAddressMapping::_internal_networkaddress() const {
  return networkaddress_.Get();
}
inline void ServiceAndNetworkAddressMapping::_internal_set_networkaddress(const std::string& value) {
  
  networkaddress_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArena());
}
...
inline void ServiceAndNetworkAddressMapping::set_networkaddress(const char* value) {
  ...
  networkaddress_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:ServiceAndNetworkAddressMapping.networkAddress)
}
inline void ServiceAndNetworkAddressMapping::set_networkaddress(const char* value,
    size_t size) {
  
  networkaddress_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
...
inline std::string* ServiceAndNetworkAddressMapping::_internal_mutable_networkaddress() {
  ...
  return networkaddress_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArena());
}
inline std::string* ServiceAndNetworkAddressMapping::release_networkaddress() {
  ...
  return networkaddress_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void ServiceAndNetworkAddressMapping::set_allocated_networkaddress(std::string* networkaddress) {
  ...
  networkaddress_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), networkaddress,
      GetArena());
